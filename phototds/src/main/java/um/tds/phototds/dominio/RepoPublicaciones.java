...
public class RepoPublicaciones {
	 ...
	 * ArrayList<Publicacion> todasPub = (ArrayList<Publicacion>)
	 * factoria.getPublicacionDAO().getAll(); ArrayList<Publicacion>
	 * publiEncontradas = (ArrayList<Publicacion>) todasPub.stream() .filter(pu ->
	 * pu.getHashtags().equals(hashtag)) .collect(Collectors.toList()); return
	 * publiEncontradas;
	 * 
	 * 
	 * }
